...
class Opportunity {
    ...
    // Static properties
    static currentOpportunityID : string;
     ...
     * @param description
     */
    constructor(opportunityID : string, title : string, organization : string, date : Date, time : string, description : string) {
     ...
     * @param preferredRole
     */
    static signUp(opportunityID : string, fullName : string, emailAddress : string, preferredRole : string) {
        // Validate name
