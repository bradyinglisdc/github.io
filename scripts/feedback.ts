...
document.addEventListener("DOMContentLoaded", function () {
    ...
    feedbackForm.addEventListener("submit", function (event) {
        ...
        // Get form values
        const feedbackNameInput = document.getElementById("feedbackName") as HTMLInputElement | null;
        const feedbackMessageInput = document.getElementById("feedbackMessage") as HTMLInputElement | null;
        ...
        setTimeout(() => {
            // Get modal elements
            const modalName = document.getElementById("modalName") as HTMLElement | null;
            const modalMessage = document.getElementById("modalMessage") as HTMLElement | null;
            ...
            feedbackModalEl.addEventListener("shown.bs.modal", function () {
                const closeButton = document.querySelector("#feedbackModal .btn-close") as HTMLElement | null;
